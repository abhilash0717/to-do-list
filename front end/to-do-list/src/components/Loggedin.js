            ...
            >
              ...
              <div className="row" style = {{marginTop : "10px"}}>
                <div className="col-md-10">
                    <input className = "form-control" type = "text" placeholder = "write your to-do here"></input>
                </div>

                <div className="col-md-2">
                  <button style = {{marginRight : "40px"}} className = "btn btn-outline-secondary">Add</button>
                </div>
              </div>
              <h5 style = {{marginTop : "20px"}}>All to-do's</h5>
               ...
               <div className = "row" >
                   ...
                   <div className = "col-md-3">
                        <h6><i class="fa fa-trash" aria-hidden="true"></i>completed</h6>
                   </div>
               </div>
               <br></br>
            </form>
